...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="product-card relative group transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl overflow-hidden bg-white rounded-2xl border border-pink-50">
