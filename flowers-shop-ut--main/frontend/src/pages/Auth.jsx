            ...
            {!isLogin && role === 'seller' && (
              <>
                <div className="auth-field">
                  ...
                  <div>
                    <input type="text" required value={businessName} onChange={(e) => setBusinessName(e.target.value)} className="auth-input" placeholder="e.g. Bloom & Petal" />
                  </div>
                </div>
                <div className="auth-field">
                  <label>Business Address</label>
                  <div>
                    <textarea required value={businessAddress} onChange={(e) => setBusinessAddress(e.target.value)} className="auth-input" placeholder="Full shop address..." style={{ minHeight: '80px' }} />
                  </div>
                </div>
              </>
            )}
